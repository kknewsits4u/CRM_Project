  ...
  return (
    ...
    <div  className=' flex flex-col w-full h-fit  px-3 mt-5 gap-2' >
        ...
        <div  className=' flex items-center justify-between w-full h-60 md:h-70 rounded gap-2 ' >
          <div className=' flex items-center justify-center w-1/3 border border-blue-200 bg-white h-full cursor-pointer' onClick={handleFileImport} > <p className=' font-semibold text-slate-700' >Import <br />  Export </p>
           </div>
